...
public class GuestBookController {
    ...
    public DataVO getGuestBookDelete(@PathVariable("gb_idx") String gb_idx, Authentication authentication) {
        DataVO dataVO = new DataVO();
        try {
            // 로그인 여부 확인
    ...
    public DataVO getGuestBookUpdate(@PathVariable("gb_idx") String gb_idx, @RequestBody GuestBookVO gvo, Authentication authentication) {
        DataVO dataVO = new DataVO();
        try {
            // 로그인 여부 확인
            if (authentication == null) {
